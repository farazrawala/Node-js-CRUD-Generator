...
async function insertOrderReferencedInventoryMovement({
  ...
  req.body = {
    ...
    reference_id: orderId,
    reference_name: orderGlDescription(referenceName, orderNo),
...
/** GET /order/profit-by-order-item — alias for {@link profitByOrderItem}. */
async function findProfitByOrderItem(req, res) {
  return profitByOrderItem(req, res);
}
