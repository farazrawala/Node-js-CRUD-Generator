...
async function checkHeaderAuthentication(req, res, next) {
  ...
  const publicRoutePatterns = [
    ...
    /^\/process\/execute-process\/.*/,
    /^\/api\/process\/execute-process\/.*/,
    // Bulk restart failed/not_started processes (public; company_id in path/query)
    "/process/restart-all",
    ...
    "/api/whatsapp_messages/fetch-random",
    /^\/whatsapp_message\/mark-sent\/.*/,
    /^\/api\/whatsapp_message\/mark-sent\/.*/,
    /^\/whatsapp_messages\/mark-sent\/.*/,
    /^\/api\/whatsapp_messages\/mark-sent\/.*/,
    /^\/whatsapp_message\/mark-not-available\/.*/,
    ...
    "/chat/can-send-unknown",
    "/api/chat/can-send-unknown",
    "/chats/can-send-unknown",
    "/api/chats/can-send-unknown",
    "/chat/reset-unknown-usage",
    "/api/chat/reset-unknown-usage",
    "/chats/reset-unknown-usage",
    "/api/chats/reset-unknown-usage",
    "/chat/reset-unknown-usage-only",
    "/api/chat/reset-unknown-usage-only",
    "/chats/reset-unknown-usage-only",
    "/api/chats/reset-unknown-usage-only",
    /^\/chat\/mark-sent\/.*/,
    /^\/api\/chat\/mark-sent\/.*/,
    /^\/chats\/mark-sent\/.*/,
    /^\/api\/chats\/mark-sent\/.*/,
