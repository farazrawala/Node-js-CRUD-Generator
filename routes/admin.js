...
const adminUserPasswordController = require("../controllers/adminUserPassword");
...
const userAdminCRUD = adminCrudGenerator(
  ...
  ],
  {
    ...
    mountExtraRoutes: (userRouter) => {
      userRouter.post(
        "/:id/reset-password",
        adminUserPasswordController.resetUserPassword,
      );
    },
  },
);
...
const integrationAdminCRUD = adminCrudGenerator(
  ...
  ],
  {
    ...
    fieldTypes: {
      ...
      description: "textarea",
      image: "file",
      sync_product_name: "select",
      sync_product_slug: "select",
      sync_product_image: "select",
      sync_product_price: "select",
      sync_product_description: "select",
      sync_product_status: "select",
      company_id: "select",
      created_by: "select",
      status: "select",
...
// Explicit password reset (must work even if CRUD mountExtraRoutes is stale on old process)
router.post(
