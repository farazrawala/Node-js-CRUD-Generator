...
router.get("/product/recent-product-ids", getRecentLineItemProductIds);
...
router.post("/process/restart-process", processRestart);
...
router.post("/process/restart-all/:companyId", processRestartAll);
router.get("/process/restart-all/:companyId", processRestartAll);
router.post("/process/restart-process-all", processRestartAll);
router.get("/process/restart-process-all", processRestartAll);
router.post("/process/restart-process-all/:companyId", processRestartAll);
router.get("/process/restart-process-all/:companyId", processRestartAll);
...
router.get("/orders/top-selling-products", findTopSellingProducts);
